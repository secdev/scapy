...
class IKEv2_V(IKEv2_Payload):
    ...
    fields_desc = IKEv2_Payload.fields_desc[:3] + [
        XStrLenField("vendorID", "", length_from=lambda x:x.length - 4),
    ]
...
class IKEv2_IDi(IKEv2_Payload):  # RFC 7296, section 3.5
    ...
    fields_desc = IKEv2_Payload.fields_desc[:3] + [
        ...
        MultipleTypeField(
            ...
            XStrLenField("ID", "", length_from=lambda x: x.length - 8),
        )
    ]
...
class ConfigurationAttribute(Packet):
    ...
    fields_desc = [
        ...
        MultipleTypeField(
            ...
            XStrLenField("value", "", length_from=lambda x: x.length),
        )
    ]
...
class IKEv2_CERTREQ(IKEv2_Payload):
    ...
    fields_desc = IKEv2_Payload.fields_desc[:3] + [
        ...
        XStrLenField("cert_authority", "", length_from=lambda x:x.length - 5),
    ]
