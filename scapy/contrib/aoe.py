...
#from scapy.fields import BitField, BitEnumField, FlagsField, ByteEnumField, XShortField, XByteField, ByteField, ByteEnumField, XIntField, StrLenField, ShortField, ConditionalField, PacketField
...
class Directive(Packet):
    ...
    fields_desc =   [   ByteField("reserved", 0),
		        ByteEnumField("dcmd", 0, {0:"No directive", 1:"Add mac address to mask list", 2:"Delete mac address from mask list"}),
...
class ReserveRelease(Packet):
    ...
    fields_desc =   [   ByteEnumField("rcmd", 0, {0:"Read Reserve List", 1:"Set Reserve List", 2:"Force Set Reserve List"}),
