...
from scapy.compat import Union, cast
...
class DoIP(Packet):
    ...
    fields_desc = [
        ...
        }), lambda p: cast(DoIP, p).payload_type in [0x0]),
        ConditionalField(StrFixedLenField("vin", b"", 17),
                         lambda p: cast(DoIP, p).payload_type in [3, 4]),
        ConditionalField(XShortField("logical_address", 0),
                         lambda p: cast(DoIP, p).payload_type in [4]),
        ConditionalField(StrFixedLenField("eid", b"", 6),
                         lambda p: cast(DoIP, p).payload_type in [2, 4]),
        ...
        ConditionalField(XShortField("source_address", 0),
                         lambda p: cast(DoIP, p).payload_type in [5, 8, 0x8001, 0x8002, 0x8003]),  # noqa: E501
        ConditionalField(XByteEnumField("activation_type", 0, {
            0: "Default", 1: "WWH-OBD", 0xe0: "Central security"
        }), lambda p: cast(DoIP, p).payload_type in [5]),
        ConditionalField(XShortField("logical_address_tester", 0),
                         lambda p: cast(DoIP, p).payload_type in [6]),
        ...
        ConditionalField(XIntField("reserved_iso", 0),
                         lambda p: cast(DoIP, p).payload_type in [5, 6]),
        ...
        }), lambda p: cast(DoIP, p).payload_type in [0x4004]),
        ConditionalField(ByteEnumField("node_type", 0, {
            0: "DoIP gateway", 1: "DoIP node"
        }), lambda p: cast(DoIP, p).payload_type in [0x4002]),
        ...
        ConditionalField(XShortField("target_address", 0),
                         lambda p: cast(DoIP, p).payload_type in [0x8001, 0x8002, 0x8003]),  # noqa: E501
        ConditionalField(XByteEnumField("ack_code", 0, {0: "ACK"}),
                         lambda p: cast(DoIP, p).payload_type in [0x8002]),
        ...
        }), lambda p: cast(DoIP, p).payload_type in [0x8003]),
    ]
