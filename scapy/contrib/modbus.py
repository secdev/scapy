...
class ModbusADURequest(Packet):
    ...
    def guess_payload_class(self, payload):
        ...
        if function_code == 0x2B and sub_code in _mei_types_request.keys():
            return _mei_types_request[sub_code]
        elif function_code in _modbus_request_classes.keys():
...
class ModbusADUResponse(Packet):
    ...
    def guess_payload_class(self, payload):
        ...
        if function_code == 0x2B and sub_code in _mei_types_response.keys():
            return _mei_types_response[sub_code]
        elif function_code in _modbus_response_classes.keys():
            return _modbus_response_classes[function_code]
        elif function_code in _modbus_error_classes.keys():
