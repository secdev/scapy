...
class EIR_ServiceSolicitation128BitUUID(EIR_Element):
    ...
    fields_desc = [UUIDField("svc_uuid", None, uuid_fmt=UUIDField.FORMAT_REV)]
...
class HCI_Cmd_Periodic_Inquiry_Mode(Packet):
    ...
    fields_desc = [
        LEShortField("max_period_length", 0x0003),
...
class HCI_Cmd_Change_Connection_Packet_Type(Packet):
    ...
    fields_desc = [
        XLEShortField("connection_handle", None),
...
class HCI_Cmd_Link_Key_Selection(Packet):
    ...
    fields_desc = [
        ByteEnumField(
            ...
            0,
            {
                0: "Use semi-permanent Link Keys",
...
class HCI_Cmd_Write_Extended_Inquiry_Response(Packet):
    ...
    fields_desc = [ByteField("fec_required", 0), HCI_Extended_Inquiry_Response]
...
class HCI_LE_Meta_Extended_Advertising_Reports(Packet):
    ...
    fields_desc = [
        FieldLenField("num_reports", None, count_of="reports", fmt="B"),
        PacketListField(
            "reports",
            None,
...
class HCI_Mon_System_Note(Packet):
    ...
    fields_desc = [StrNullField("note", None)]
